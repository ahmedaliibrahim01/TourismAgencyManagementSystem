...
public class Reservation {
    ...
    public Reservation(int id, int room_id, String guest_name, String guest_id, String guest_mail, String guest_phone, int adult_count, int child_count, LocalDate check_in_date, LocalDate check_out_date, String guest_note, double total_price) {
        this.id = id;
